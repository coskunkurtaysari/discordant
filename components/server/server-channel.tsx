...
import { Edit, Hash, Lock, Mic, Trash, Video, Disc3 } from "lucide-react";
  ...
  return (
    <button
      ...
      className={cn(
        ...
        channel.type === ChannelType.STUDIO && "bg-orange-600/20 hover:bg-orange-500/30 border-l-4 border-orange-400"
      )}
    >
      <Icon className={cn(
